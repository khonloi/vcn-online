    ...
    <header className={styles.headerWrapper}>
          ...
          <div className={styles.marketTicker} aria-label="Market Data">
            {marketIndices.map((item) => (
              <div key={item.name} className={styles.marketItem}>
                <span>{item.name}</span>
                <span className={item.positive ? styles.marketPositive : styles.marketNegative}>
      ...
      <div className={styles.mainHeader}>
        <div className={`container ${styles.mainHeaderContent}`}>
          <Link href="/" className={styles.logo} aria-label="Vice City News Homepage">
            VICE CITY <span>NEWS</span> <span className={styles.logoBadge}>LIVE</span>
          </Link>
      ...
      <nav className={styles.navBar} aria-label="Main Navigation">
        <div className={`container ${styles.navLinks}`}>
          ...
          <Link href="/tech" className={styles.navLink}>Tech</Link>
          <Link href="/finance" className={styles.navLink}>Finance</Link>
          ...
          <Link href="/lifestyle" className={styles.navLink}>Lifestyle</Link>
